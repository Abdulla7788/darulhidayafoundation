        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {galleryItems.map((item, i) => (
            <motion.div 
              ...
              viewport={{ once: true }}
              className="group relative rounded-2xl overflow-hidden shadow-4xl bg-white border border-slate-50"
            >
              <div className="aspect-video overflow-hidden">
                <img 
                  ...
                  style={{ objectPosition: item.img.includes('pic7.jpeg') ? 'center 30%' : 'center' }}
                />
              </div>
            </motion.div>
          ))}
